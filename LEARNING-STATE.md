...
5. technical-v2 confirmed dev 已满足 stable 条件，证据汇总见 `evidence/technical/technical-v2/dev-stability-01.json`；下一入口是生成独立 holdout candidate questions，供本人 review、删改和选定，暂不冻结或运行。
