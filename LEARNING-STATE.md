...
> SHA-256、离线解压方法和范围边界。未加入完整 Bub 仓库或 Git 历史。论断 10 延期，不阻断 W13。
> 同步修正现行文档中的自造组合词：验收名称只保留对象与类型，具体操作和通过条件在正文展开。
> 本轮只修改白名单文档与证据资产，未修改 Bub 或学习代码，未提供黑名单 L2，**不新增债务**；未提交。
>
> 上一次更新：2026-09-05（Asia/Shanghai，**W12 概念地图阅读接线与笔记深链完成，待本人人工视觉验收**）：
...
> 仓库主人仍需完成概念地图的四项人工视觉验收：隐藏标题与结论后复述五对象/五类关系、10 秒结论、
> 视觉记忆点与首屏主路径判断。D6 主线仍进行中，
...
> 彩排。B3 图示人工验收、vendor 取舍复核、论断 10
...
- **2026-09-06（B3 验收与 Bub 离线源码证据）**：本人确认 B3 图示人工验收已完成。AI 以实现方模式
  ...
  同步用直接的验收对象、操作和通过条件替换自造组合词，并补强技术文案规范。论断 10 延期；未修改
  Bub 或学习代码，未提供黑名单 L2，**不新增债务**。
...
- **2026-09-05（W12 遗留项收口）**：AI 以实现方模式完成白名单 B3 展示资产，按报告 §4 重做数据
  ...
  vendor 快照与论断 10 当时按成本/范围记录为未做；未修改 Bub 或 production 代码，未提供黑名单 L2，
  **不新增债务**。仓库主人的 B3 图示人工验收当时保留，后于 2026-09-06 完成。
...
- **2026-09-03（W12 D4 展板增量）**：AI 以实现方模式完成白名单展示资产，subagent 分别负责视觉
  ...
  **未提供黑名单 L2，不新增债务**。仓库主人的标题遮挡测试仍保留为独立人工视觉验收。
