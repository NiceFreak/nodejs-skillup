...
export const NOTES = [
  ...
  { id: "w13d5", group: "RAG 实践记录", label: "D5 · Dense 接线与诊断", description: "LangChain dense 接线、端到端证据与 dev 逐题质量诊断", load: () => import("../../../../week13-rag/notes/day5-dense-langchain-wiring.md?raw").then((m) => m.default), file: "day5-dense-langchain-wiring.md", repoPath: "week13-rag/notes/day5-dense-langchain-wiring.md", reviewOnly: true, restrictionNote: "包含实现决策、质量诊断与本人验收边界，仅在复习状态打开。" },
  ...
  { id: "w13ragcode", group: "RAG 实践记录", label: "D6 · 固定 RAG 代码导读", description: "固定 LangChain RAG 的函数链路、失败分层和实现边界", load: () => import("../../../../week13-rag/notes/day6-rag-code-walkthrough.md?raw").then((m) => m.default), file: "day6-rag-code-walkthrough.md", repoPath: "week13-rag/notes/day6-rag-code-walkthrough.md", reviewOnly: true, restrictionNote: "包含 D6 代码职责与未实现边界，仅在复习状态打开。" },
  { id: "w13bridge", group: "RAG 实践记录", label: "D6 · D5 事实与模块对接", description: "D5 实际变更、未完成事项与 D6 M0–M7 对照", load: () => import("../../../../week13-rag/notes/day6-d5-facts-and-d6-bridge.md?raw").then((m) => m.default), file: "day6-d5-facts-and-d6-bridge.md", repoPath: "week13-rag/notes/day6-d5-facts-and-d6-bridge.md", reviewOnly: true, restrictionNote: "包含阶段状态和本人验收边界，仅在复习状态打开。" },
