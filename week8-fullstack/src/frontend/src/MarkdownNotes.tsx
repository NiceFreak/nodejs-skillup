...
const NOTES: NoteSource[] = [
  ...
  { id: "w9roadmap", label: "W9 浓缩地图", description: "D1–D4 的目标拓扑、端口表、认知修正与白话对照表（§6.1 / §6.2 已含 8/13 两次收口）", load: () => import("../../../../week9-deployment/notes/week9-roadmap-d1-d4.md?raw").then((m) => m.default), file: "week9-roadmap-d1-d4.md", repoPath: "week9-deployment/notes/week9-roadmap-d1-d4.md", reviewOnly: true },
