...
**顺延规则**：没到 P4 就收工，明天继续 D2；到了 P4，阶段 B 没做完的条目顺延进 D4 之前，**不挤压 D4 的公网 HTTPS 主线**。W9 当时预计从 5 天变成 6 天（收口顺延到 8/15），这是 D2 排多了的结果，不是新的超支（**后记 2026-08-13：这次顺延最终没有发生，D3/D4 都按期压了回来，收口仍是 8/14**）——如果 D4/D5 还要顺延，那时候该砍的是 Java stretch，不是链路验收。
