...
- 时间锚点：**暂定周五 8/14（D5 收口日）前**（原稿写「周五 8/15」，而 8/15 是周六——2026-08-13 更正，见 week9-plan §4 排期修订）；与 D5 基建收口（重启/证书/端口/冷路径/demo 叙述）若挤兑，**优先 D5，补鉴权顺延至 D5 后第一个工作日**。demo 叙述 = 本人验收（能讲清），AI 只出素材。
...
- **周计划变更（连带）**：HTTPS 明确顺延（D4-HTTPS 不在今天收口）；D5（8/14）的「证书续期检查」依赖证书在位 → 需在收口时更新 week9-plan/LERNING-STATE，D5 该项相应调整或 D5 顺延决策。
